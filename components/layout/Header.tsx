      ...
      <div className="relative min-h-[70vh] flex items-center justify-center px-4 py-20">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8">
            ...
            <span className="text-sm font-medium">2025 年最新资源</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <GlassButton variant="outline" size="lg" href="/resources">
              浏览全部资源
            </GlassButton>
          </div>
          ...
          <div className="flex items-center justify-center gap-8 mt-12 pt-8 border-t border-white/10">
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">25+</div>
